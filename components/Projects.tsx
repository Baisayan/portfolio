...
const Projects = () => {
  const projects: Project[] = [
    ...
    },
    {
      ...
      description:
        "DSA sheet converter that transforms popular problem sheets (Striver SDE, A2Z, Blind 75, Last Moment) into Excel, Markdown, and CSV formats with smart filtering, progress tracking, custom metadata, and a clean responsive UI.",
    ...
    },
    {
      ...
      description:
        "College-exclusive platform where students share thoughts with 24-hour auto-deletion, like/dislike system, and role-based APIs for admins and users.",
